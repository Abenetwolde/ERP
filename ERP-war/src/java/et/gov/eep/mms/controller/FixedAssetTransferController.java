...
//</editor-fold>
    ...
    private boolean disableEmployee = false;
    private boolean disableTransferDepartment = false;
...
//</editor-fold>
    ...
    @PostConstruct
    public void init() {
        System.out.println("workflow.isPrepareStatus()==" + workflow.isPrepareStatus());
        ...
        System.out.println("workflow.isRequestStatus() ==" + workflow.isRequestStatus());
        if (workflow.isApproveStatus() || workflow.isCheckStatus()) {
        ...
        } else if (workflow.isRequestStatus()) {
            System.out.println("inside RequestStatus ");
            mmsTrList = TransferInterface.findTrListByWfStatus(Constants.CHECK_REJECT_VALUE);
            renderDecision = false;
            isRenderCreate = true;
            ...
            hrEmployeesEntity.setId(SessionBean.getEmpId());
            hrEmployeesEntity = hrEmployeeInterface.searchById(hrEmployeesEntity);
            System.out.println("hrEmployeesEntity empod=wewee=="+hrEmployeesEntity.getEmpId());
...
//</editor-fold>
    ...
    public boolean isDisableTransferDepartment() {
        return disableTransferDepartment;
    }

    public void setDisableTransferDepartment(boolean disableTransferDepartment) {
        this.disableTransferDepartment = disableTransferDepartment;
    }
