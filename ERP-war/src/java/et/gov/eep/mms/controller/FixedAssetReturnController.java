...
//</editor-fold>
    ...
    private boolean disableDepartment = false;
...
//</editor-fold>
    ...
    public void init() {
        ...
        if (workflow.isApproveStatus() || workflow.isCheckStatus()) {
           ...
           hrEmployees.setId(SessionBean.getEmpId());
           hrEmployees = hrEmployeesFacade.searchById(hrEmployees);
            System.out.println("hrEmployeesEntity empod=wewee=="+hrEmployees.getEmpId());
...
//</editor-fold>
    ...
    public boolean isDisableDepartment() {
        return disableDepartment;
    }

    public void setDisableDepartment(boolean disableDepartment) {
