...
//</editor-fold>
    ...
    public void init() {
        ...
        if (workflow.isApproveStatus() || workflow.isCheckStatus()) {
           ...
           employeEntity.setId(SessionBean.getEmpId());
           employeEntity = hrInterface.searchById(employeEntity);
           System.out.println("hrEmployeesEntity empod=wewee=="+employeEntity.getEmpId());
