...
//</editor-fold>
    ...
    private List<HrTransferRequests> transferHistoryList;
...
//</editor-fold>
    ...
    public void init() {
        ...
        if (workflow.isRequestStatus()) {
            ...
            emp = hrEmployees.getFirstName() + hrEmployees.getMiddleName() + hrEmployees.getLastName();
            transferHistoryList = transferReqBeanLocal.findByOne(hrEmployees);
...
//</editor-fold>
    ...
    public List<HrTransferRequests> getTransferHistoryList() {
        return transferHistoryList;
    }

    public void setTransferHistoryList(List<HrTransferRequests> transferHistoryList) {
    ...
    public List<String> getStatusAppRej() {
        return StatusAppRej;
    }
...
//        }
    ...
    private void populateRequestList(Status status) {
        try {
            transferList = transferReqBeanLocal.loadTransferList(status.getStatus1());
            transferRequestsDataModel = new ListDataModel<>(transferList);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
