...
//</editor-fold>
    ...
    private List<HrActingAssignments> actingAssignmentHistory = new ArrayList<>();
    ...
    private boolean renderPlusIcon = true;
//</editor-fold>
    ...
    public void init() {
        ...
        hrActingAssignment.setActingType("Employee");
        if (workFlow.isRequestStatus()) {
            ...
            hrEmployees.setId((sessionBeanLocal.getEmpId()));
            ...
            hrActingAssignment.setAssignedBy(hrEmployees);
            hrActingAssignment.setActingType("Employee");
            headerTitle = "Acting Assignment Request";
            actingAssignmentHistory = actingAssignmentBeanLocal.loadEmpActingAssignmentHistoty(hrEmployees);
        } else {
...
//</editor-fold>
    ...
    public boolean isRenderPlusIcon() {
        return renderPlusIcon;
    }

    public void setRenderPlusIcon(boolean renderPlusIcon) {
        this.renderPlusIcon = renderPlusIcon;
    }
    ...
    public void setApproverRejectstatus(int approverRejectstatus) {
        this.approverRejectstatus = approverRejectstatus;
    }

    public List<HrActingAssignments> getActingAssignmentHistory() {
        return actingAssignmentHistory;
    }

    public void setActingAssignmentHistory(List<HrActingAssignments> actingAssignmentHistory) {
        this.actingAssignmentHistory = actingAssignmentHistory;
    }
    ...
    public void getByDelegateName(SelectEvent event) {
        try {
            ...
            hrActingAssignment.setAssignedPerson(delegateEmp);
    ...
    public void populateActingAssignment(SelectEvent event) {
        ...
        hrEmployees = hrActingAssignment.getAssignedBy();
