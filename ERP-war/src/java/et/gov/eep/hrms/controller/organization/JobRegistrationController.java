...
//</editor-fold>
    ...
    public void init() {
        ...
        Languagelocalbean.setSaveOrUpadetStatus(updateStatus);
        SaveOrUpdateButton = Languagelocalbean.getSaveOrupdate();
    ...
    public void getByJobCode(SelectEvent event) {
        try {
            if (event.getObject() != null) {
                ...
                Languagelocalbean.setSaveOrUpadetStatus(updateStatus);
                SaveOrUpdateButton = Languagelocalbean.getSaveOrupdate();
                AddOrModify = Languagelocalbean.getAddOrModify();
...
//</editor-fold>
    ...
    public void addQual() {
        if (checkDuplicateEducation()) {
          ...
          Languagelocalbean.setAddOrModifyStatus(0);
        } else {
    ...
    public void selectJobQual(SelectEvent event) {
        updateStatus = 1;
        Languagelocalbean.setSaveOrUpadetStatus(updateStatus);
        Languagelocalbean.setAddOrModifyStatus(updateStatus);
        AddOrModify = Languagelocalbean.getAddOrModify();
