...
public class TerminationRequestController implements Serializable {
    ...
    public void init() {
        ...
        System.out.println("sessionBean.getEmpId()===" + sessionBeanLocal.getEmpId());
        System.out.println("sessionBean.getFirstName()==" + sessionBeanLocal.getFirstName());
        if (workFlow.isRequestStatus()) {
            System.out.println("requester");
            disabledEmpId = true;
            hrEmployees.setId((sessionBeanLocal.getEmpId()));
            hrEmployees = employeeBean.searchById(hrEmployees);
    ...
    public ArrayList<HrEmployees> searchEmployeeById(String empId) {
        ...
        employee = employeeBean.SearchByEmpId(hrEmployees);
        return employee;
    }
