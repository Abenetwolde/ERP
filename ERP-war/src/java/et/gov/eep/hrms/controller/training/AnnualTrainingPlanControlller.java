...
//        hrTdAnnualTraParticipantsDataModel = new ListDataModel(new ArrayList(hrTdAnnualTraParticipantsBeanLocal.SrchAnnTraNeedIdToBeApproved(hrTdAnnualTraParticipants)));
    ...
    int yearDifferenceStart;
    int yearDifferenceEnd;
    ...
    public void dateValidation() {
        ...
        yearDifferenceStart = hrTdAnnualNeedRequests.getBudgetYear() - isStartYear;
        yearDifferenceEnd = hrTdAnnualNeedRequests.getBudgetYear() - isEndYear;
    }
    ...
    public void addPlanGroup() {
        ...
        } else if ((yearDifferenceStart != 0) && (yearDifferenceEnd != 0)) {
            JsfUtil.addFatalMessage("Start date and end date should be in budget year");
...
//            hrTdAnnualPlans.getHrTdAnnualPlanGroupsList().add(hrTdAnnualPlanGroup);
    ...
    public void editPlanGroup() {
        ...
        localBeanObj.setAddOrModifyStatus(1);
    }
