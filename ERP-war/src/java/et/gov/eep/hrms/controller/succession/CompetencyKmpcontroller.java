...
public class CompetencyKmpcontroller implements Serializable {
    ...
    List<HrSmCompetencyTypes> compListSkill;
    String skill = "skill";
...
// </editor-fold> 
    ...
    public void init() {
        ...
        compListSkill = competencyTypeLocal.findBySkill(skill);
    ...
    public List<HrSmCompetencyTypes> getCompListSkill() {
        if (compListSkill == null) {
            compListSkill = new ArrayList<>();
        }
        return compListSkill;
    }

    public void setCompListSkill(List<HrSmCompetencyTypes> compListSkill) {
        this.compListSkill = compListSkill;
    }
