...
//</editor-fold>
    ...
    public void getJobLevelsPaymentIn(ValueChangeEvent event) {
        try {
            ...
            if (localBeanObj.getLangsession().getAttribute("lang").toString().equalsIgnoreCase("am")) {
                setLableValue("መጠን በብር");
                System.out.println("============inside amharic bundle==========");
                if (event.getNewValue().toString().equalsIgnoreCase("ብር")) {
                    System.out.println("==========inside birr in amharic============");
                    lableValue = "መጠን በብር:";
                } else if (event.getNewValue().toString().equalsIgnoreCase("በመቶ")) {
                    lableValue = "መጠን በብር:";
                } else if (event.getNewValue().toString().equalsIgnoreCase("ዓይነት")) {
                    lableValue = "መጠን በዓይነት:";
                } else if (event.getNewValue().toString().equalsIgnoreCase("ዓይነት በብር/በመጠን")) {
                    lableValue = "መጠን:";
                }
            } else {
