...
//                status.setStatus3(Constants.APPROVE_REJECT_VALUE);
            ...
            }else if (permissionValues.isRequest()) {

                status.setStatus1(Constants.REQUEST_VALUE);
                status.setStatus2(Constants.REQUEST_VALUE);
//                status.setStatus3(Constants.APPROVE_REJECT_VALUE);
                userStatus = Constants.REQUEST_VALUE;
                btnBundle = "request";
                buttonStatus = true;
                RequestStatus = true;
                preparedBy = userName;
