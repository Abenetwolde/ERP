...
public class MmsFixedAssetRegistrationBean implements MmsFixedAssetRegistrationBeanLocal {
    ...
    public HrEmployees findById(HrEmployees employeeFirst) {
        return farRegistrationFacade.findById(employeeFirst);
    }

    @Override
    public ArrayList<MmsFixedassetRegstDetail> regstrationsucs(String empId) {
        return farRegistrationFacade.regstrationsucs(empId);
    }

    @Override
    public ArrayList<MmsFixedassetRegstration> regstrationsuc(String regstrationucs) {
        return farRegistrationFacade.regstrationsuc(regstrationucs);
    }
}
