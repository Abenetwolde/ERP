...
public class HrDocumentTypesFacade extends AbstractFacade<HrDocumentTypes> {
    ...
    public HrDocumentTypes getById(HrDocumentTypes doctype) {
        Query query = em.createNamedQuery("HrDocumentTypes.findById", HrDocumentTypes.class);
        query.setParameter("id", doctype.getId());
        return (HrDocumentTypes)query.getSingleResult();
    }
